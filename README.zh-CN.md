...
[LeRobot](https://github.com/huggingface/lerobot) **v0.6.2** 的定制分支，为 **SO-ARM101 从动臂 + AmazingHand 灵巧手** 增加完整的遥操作、标定、数据采集与策略部署支持。

- **本仓库：**<https://github.com/Juxi-Rui/Lerobot-AmazingHand>
- **上游仓库：**<https://github.com/huggingface/lerobot>
- **基线版本：**`lerobot` 0.6.2，Apache-2.0
- **详细文档：**[`tutorials/`](tutorials/README.md)（六阶段 × Windows/Linux）· 单文件速查：[`SO_ARM101_AMAZINGHAND_GUIDE.md`](SO_ARM101_AMAZINGHAND_GUIDE.md)
